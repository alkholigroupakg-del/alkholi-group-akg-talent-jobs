...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    "admin.otpSent": "تم إرسال كود التحقق إلى بريدك الإلكتروني",
    "admin.otpSendError": "فشل إرسال كود التحقق. حاول مرة أخرى.",
    "admin.otpInvalid": "كود التحقق غير صحيح أو منتهي الصلاحية",
    "admin.otpLabel": "أدخل كود التحقق",
    "admin.otpDesc": "تم إرسال كود مكون من 6 أرقام إلى بريدك الإلكتروني",
    "admin.verifyOtp": "تحقق",
    "admin.resendOtp": "إعادة إرسال الكود",
  },
  en: {
    // Navbar & general
    "nav.apply": "Apply Now",
    ...
    "admin.otpSent": "Verification code sent to your email",
    "admin.otpSendError": "Failed to send verification code. Try again.",
    "admin.otpInvalid": "Invalid or expired verification code",
    "admin.otpLabel": "Enter verification code",
    "admin.otpDesc": "A 6-digit code has been sent to your email",
    "admin.verifyOtp": "Verify",
    "admin.resendOtp": "Resend code",
  },
};
